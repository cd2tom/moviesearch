...
},{"./arrayWithHoles":"../node_modules/@babel/runtime/helpers/arrayWithHoles.js","./iterableToArrayLimit":"../node_modules/@babel/runtime/helpers/iterableToArrayLimit.js","./nonIterableRest":"../node_modules/@babel/runtime/helpers/nonIterableRest.js"}],"config/application.yml":[function(require,module,exports) {
module.exports = {
  KEY: "4cebac2fda4a703492df38d7d8bfdf33"
};
},{}],"utils/movieDB.js":[function(require,module,exports) {
"use strict";
...
exports.generateBgUrl = generateBgUrl;
...
var APIKEY = require("../config/application.yml").KEY;

var APIPATH = "https://api.themoviedb.org/3";

function fetchSearch(_x, _x2) {
  return _fetchSearch.apply(this, arguments);
}

function _fetchSearch() {
  _fetchSearch = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(queryValue, pageNumber) {
    var path, response, parsed, totalPages, results;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            path = "".concat(APIPATH, "/search/movie?query=").concat(queryValue, "&api_key=").concat(APIKEY, "&page=").concat(pageNumber);
            _context.next = 3;
            return fetch(path);
...
function generateBgUrl(posterPath) {
  var base = "https://image.tmdb.org/t/p/original";
  return "".concat(base).concat(posterPath);
}

function getMovie(_x3) {
  return _getMovie.apply(this, arguments);
}

function _getMovie() {
  _getMovie = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee2(id) {
    var path, response, parsed;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            path = "".concat(APIPATH, "/movie/").concat(id, "?api_key=").concat(APIKEY);
            _context2.next = 3;
            return fetch(path);
...
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","../config/application.yml":"config/application.yml"}],"components/Loader.jsx":[function(require,module,exports) {
"use strict";
...
},{"react":"../node_modules/react/index.js"}],"components/Teasers.jsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Teasers = void 0;
...
var _movieDB = require("../utils/movieDB");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Teasers = function Teasers(_ref) {
  var results = _ref.results,
      setModalResult = _ref.setModalResult;

  function handleSetModalResult(_x) {
    return _handleSetModalResult.apply(this, arguments);
  }

  function _handleSetModalResult() {
    _handleSetModalResult = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
  ...
  return _react.default.createElement("div", {
    ...
    return _react.default.createElement("article", {
      key: "".concat(i).concat(result.title),
      className: "teaser"
    }, _react.default.createElement("div", {
      style: {
        backgroundImage: "url('".concat((0, _movieDB.generateBgUrl)(result.poster_path), "')")
      },
    ...
    }, _react.default.createElement("b", null, result.title), _react.default.createElement("br", null), _react.default.createElement("small", null, result.release_date), _react.default.createElement("br", null), _react.default.createElement("span", null, result.vote_average, "/10")), _react.default.createElement("div", {
      className: "btn",
      onClick: function onClick() {
        return handleSetModalResult(result.id);
      }
    }, "View More")));
  }));
};
...
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","react":"../node_modules/react/index.js","../utils/movieDB":"utils/movieDB.js"}],"components/Pagination.jsx":[function(require,module,exports) {
"use strict";
...
var Pagination = function Pagination(_ref) {
  var currentPageNumber = _ref.currentPageNumber,
      totalPages = _ref.totalPages,
      handlePageClick = _ref.handlePageClick;
  return _react.default.createElement("div", {
    className: "pagination"
  }, Array(totalPages).fill().map(function (_, i) {
    return _react.default.createElement("span", {
      key: i,
      className: "pagination__link ".concat(currentPageNumber === i + 1 ? "pagination__link--active" : undefined),
      onClick: function onClick() {
        return handlePageClick(i + 1);
      }
    }, i + 1);
  }));
};
...
var Modal = function Modal(_ref) {
  ...
  return _react.default.createElement("div", {
    className: "modal ".concat(result ? "modal--active" : undefined),
    ...
    onClick: handleClearModalResult
  }, "x"), result && _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", {
    style: {
      backgroundImage: "url('".concat((0, _movieDB.generateBgUrl)(result.poster_path), "')")
    },
  ...
  }, _react.default.createElement("h3", null, result.title, _react.default.createElement("br", null), _react.default.createElement("small", null, result.tagline)), _react.default.createElement("p", null, result.overview)))));
};

exports.Modal = Modal;
},{"react":"../node_modules/react/index.js","../utils/movieDB":"utils/movieDB.js"}],"components/Home.jsx":[function(require,module,exports) {
"use strict";
...
var Home = function Home() {
  ...
  var _useState5 = (0, _react.useState)(undefined),
      ...
      modalResult = _useState6[0],
      setModalResult = _useState6[1];

  var _useState7 = (0, _react.useState)(false),
      _useState8 = (0, _slicedToArray2.default)(_useState7, 2),
      requestMade = _useState8[0],
      setRequestMade = _useState8[1];
  ...
  function submitQuery(_x) {
    return _submitQuery.apply(this, arguments);
  }

  function _submitQuery() {
    _submitQuery = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
  ...
  }), _react.default.createElement("button", null, "Search"))), loading && _react.default.createElement(_Loader.Loader, null), !loading && _react.default.createElement(_Teasers.Teasers, {
    results: requestData.results,
    setModalResult: setModalResult
  }), requestMade && requestData.results.length > 0 && _react.default.createElement(_Pagination.Pagination, {
...
exports.Home = Home;
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","@babel/runtime/helpers/slicedToArray":"../node_modules/@babel/runtime/helpers/slicedToArray.js","react":"../node_modules/react/index.js","../utils/movieDB":"utils/movieDB.js","./Loader":"components/Loader.jsx","./Teasers":"components/Teasers.jsx","./Pagination":"components/Pagination.jsx","./Modal":"components/Modal.jsx"}],"AppPack.jsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.AppPack = void 0;
...
var AppPack = function AppPack() {
  return _react.default.createElement(_Home.Home, null);
};

exports.AppPack = AppPack;
},{"react":"../node_modules/react/index.js","./components/Home":"components/Home.jsx"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"css/normalize.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"css/core.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var App = function App() {
  return _react.default.createElement("div", {
    className: "main"
  }, _react.default.createElement(_AppPack.AppPack, null));
};

exports.App = App;
},{"react":"../node_modules/react/index.js","./AppPack":"AppPack.jsx","./css/normalize.scss":"css/normalize.scss","./css/core.scss":"css/core.scss"}],"index.jsx":[function(require,module,exports) {
"use strict";
